...
/// <summary>
/// A struct that can be used to quickly build <see cref="NoteSpelling"/> instances.
/// </summary>
public readonly struct NoteSpellingBuilder
{
    /// <summary>
    ...
    internal NoteSpellingBuilder(NoteLetter Letter)
    {
        this.Letter = Letter;
    }
